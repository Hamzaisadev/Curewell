...
export function DoctorBriefPage() {
  ...
  const [toastTone, setToastTone] = useState<'ok' | 'risk'>('ok');
    ...
    <AppShell>
      ...
      >
        ...
        <div className="pt-4 border-t border-ink-200 text-[10px] text-ink-500 leading-relaxed">
          <p>
            Note: This clinical dossier is generated by Curewell from verified patient records and diagnostic laboratory OCR. Intended for consulting physicians and emergency healthcare providers.
          </p>
        </div>
      </div>
    </AppShell>
