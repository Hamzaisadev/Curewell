# 🌿 Curewell — Your Personal Health & Prescription Vault
...
**Curewell** is an intuitive, privacy-first personal health companion built for real everyday use. It bridges the gap between chaotic paper records and modern digital wellness by turning handwritten prescriptions, complex lab results, and daily medication routines into a clear, unified, and actionable health dashboard.

Whether managing chronic health conditions, caring for elderly parents, or keeping your family's medical history safe and organized, Curewell ensures you never lose a prescription or miss a dose again.

---

## 🎯 What You Can Do With Curewell

### 📸 1. Scan & Digitize Paper Prescriptions in Seconds
- **Snap & Extract**: Take a photo of any doctor's prescription or clinical discharge note. Curewell’s AI instantly transcribes doctor handwriting, extracting drug names, dosage strengths, intake frequencies, and treatment durations.
...
2. **Review**: Confirm details, customize your routine meal timings, and let Curewell build your personalized schedule.
